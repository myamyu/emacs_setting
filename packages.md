...
package-list-packagesのinstalledのコピペです。
...
```
  ...
  ac-html            20150506.1703 installed             auto complete source for html tags and attributes
  ...
  cider              20150726.748  installed             Clojure Interactive Development Environment that Rocks
  clojure-mode       20150726.100  installed             Major mode for Clojure code
  coffee-mode        20150602.2205 installed             Major mode to edit CoffeeScript files in Emacs
  dash               20150717.1321 installed             A modern list library for Emacs
  ddskk              20150619.1657 installed             Simple Kana to Kanji conversion program.
  epl                20150517.433  installed             Emacs Package Library
  flycheck           20150725.1346 installed             On-the-fly syntax checking
  flycheck-clojure   20150116.234  installed             Flycheck: Clojure support
  ...
  gh-md              20150528.1927 installed             Render markdown using the github api
  gist               20150505.1341 installed             Emacs integration for gist.github.com
  git-commit         20150706.331  installed             Edit Git commit messages
  ...
  helm               20150727.28   installed             Helm is an Emacs incremental and narrowing framework
  helm-core          20150725.713  installed             Development files for Helm
  ...
  helm-projectile    20150714.842  installed             Helm integration for Projectile
  ...
  js2-mode           20150726.1330 installed             Improved JavaScript editing mode
  ...
  magit              20150726.1805 installed             A Git porcelain inside Emacs
  magit-popup        20150723.1315 installed             Define prefix-infix-suffix command combos
  markdown-mode      20150724.2116 installed             Emacs Major mode for Markdown-formatted text files
  ...
  org                20150727      installed             Outline-based notes management and organizer
  pcache             20150125.1653 installed             persistent caching for Emacs
  pkg-info           20150517.443  installed             Information about packages
  polymode           20150723.156  installed             Versatile multiple modes with extensive literate programming support
  popup              20150626.711  installed             Visual Popup User Interface
  projectile         20150724.1312 installed             Manage and navigate projects in Emacs easily
  ...
  web-mode           20150722.12   installed             major mode for editing web templates
